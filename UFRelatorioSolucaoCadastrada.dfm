object FRelatorioSolucaoCadastrada: TFRelatorioSolucaoCadastrada
  Left = 0
  Top = 0
  Caption = 'Relat'#243'rio -  Solu'#231#227'o Cadastrada'
  ClientHeight = 501
  ClientWidth = 720
  Color = clBtnFace
  ...
  object gbxPrincipal: TGroupBox
    ...
    Height = 476
    Align = alClient
    Caption = '  Solu'#231#227'o de Ocorr'#234'ncia  '
    TabOrder = 0
